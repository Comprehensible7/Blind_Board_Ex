			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<span class="logo"><img src="/resources/assets/css/images/logo.svg" alt="" /></span>
						<h1>Blah Blah</h1>
						<p>相手はあなたの年齢帯だけを知っているだけです。<br />
						...
						<!-- Introduction -->
							<section id="intro" class="main">
								<div class="spotlight">
									...
									<span class="image"><img src="/resources/assets/css/images/pic01.jpg" alt="" /></span>
								</div>
							</section>
